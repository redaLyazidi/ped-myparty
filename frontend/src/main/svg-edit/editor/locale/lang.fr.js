svgEditor.readLang({
	...
	tools: { 
		...
		"save_doc": "Enregistrer le ticket",
	...
	notification: {
		...
		"cannotLoadImageUrlPleaseSelectNewOne":"L'image %s provient d'un document externe et ne peut pas être chargée directement. Choisissez s'il vous plait un emplacement d'où la charger."
	}
});
